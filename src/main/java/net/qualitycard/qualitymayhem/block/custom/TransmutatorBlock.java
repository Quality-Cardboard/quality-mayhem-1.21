...
public class TransmutatorBlock extends Block {
    ...
    // Overriding the Tooltip of the Transmutator
    @Override
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        tooltip.add(Text.translatable("tooltip.qualitymayhem.transmutator_block.tooltip"));
        tooltip.add(Text.translatable("tooltip.qualitymayhem.transmutator_block.tooltip.2"));
